(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-chat-detail-chat-detail-module~pages-chat-list-chat-list-module"], {
        ...
        _createClass(ChatService, [{
          ...
          value: function sendMsg(docId, txt, itemSaler, buyer, chatid) {
            ...
            this.afs.collection("messages").add(msg).then(function (ref) {
              ...
              _this.afs.doc("chats/".concat(chatId)).get().subscribe(function (result) {
                if (result.exists) {
                  _this.afs.collection("chats").doc(chatId).update({
                    lmsg: txt.txtMsg,
                    created: createdDate
                  });
                } else {
                  _this.afs.collection("chats").doc(chatId).set({
                    chatId: chatId,
                    sender: buyer,
                    receiver: itemSaler,
                    item: docId,
          ...
          value: function chatListGetMsgs(chat_Id) {
            ...
            return this.afs.collection("chats", function (ref) {
              ...
              return actions.map(function (a) {
                ...
                return _this2.afs.collection("messages", function (ref) {
          ...
          value: function getMsgs(item, sender) {
            ...
            return this.afs.collection("chats", function (ref) {
              ...
              return actions.map(function (a) {
                ...
                var id = a.payload.doc.id;
                console.log("########## Chat ############# =" + JSON.stringify(data));
                return _this3.afs.collection("messages", function (ref) {
                  return ref.where("chatID", "==", id).orderBy("created", "asc");
                }).valueChanges().pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_5__["map"])(function (msgs) {
                  console.log("+++++++++++++++++  message List +++++++++++++++ " + JSON.stringify(Object.assign({
                    id: id,
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      sender = _context.sent.uid;
                      return _context.abrupt("return", this.afs.collection("chats").ref.where("receiver.uid", "==", sender));
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      item.poster = _context2.sent.uid;
                      item.images = [];
                      item.likes = [];
                      item.prices = [];
                      item.offers = [];
                      documentId = null;
                      return _context2.abrupt("return", this.afs.collection("messages").add(item).then(function (ref) {
                        documentId = ref.id;
                      }));
    ...
    /***/
    function QUrN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddPipe, [{
        ...
        function CalendarPipe(cdRef, ngZone) {
          ...
          this.midnightSub = CalendarPipe.midnight.subscribe(function () {
            _this5.ngZone.run(function () {
              return _this5.cdRef.markForCheck();
            });
          });
        }
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CalendarPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amCalendar',
            pure: false
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DateFormatPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amDateFormat'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DifferencePipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amDifference'
          }]
          ...
          value: function _applyOptions(momentOptions) {
            ...
            if (!!momentOptions.relativeTimeThresholdOptions) {
              ...
              var filteredUnits = units.filter(function (unit) {
                return _this6.allowedUnits.indexOf(unit) !== -1;
              });
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DurationPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amDuration'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FromUnixPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amFromUnix'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ParsePipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amParse'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FromUtcPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amFromUtc'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IsAfterPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amIsAfter'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IsBeforePipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amIsBefore'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LocalTimePipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amLocal'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LocalePipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amLocale'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ParseZonePipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amParseZone'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SubtractPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amSubtract'
          }]
        ...
        _createClass(TimeAgoPipe, [{
          ...
          value: function createTimer() {
            ...
            this.currentTimer = this.ngZone.runOutsideAngular(function () {
              if (typeof window !== 'undefined') {
                return window.setTimeout(function () {
                  _this7.lastText = _this7.formatFn(momentConstructor$a(_this7.lastValue));
                  _this7.currentTimer = null;

                  _this7.ngZone.run(function () {
                    return _this7.cdRef.markForCheck();
                  });
                }, timeToUpdate);
              } else {
                return null;
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UtcPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'amUtc'
          }]
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MomentModule, [{
...
//# sourceMappingURL=default~pages-chat-detail-chat-detail-module~pages-chat-list-chat-list-module-es5.js.map