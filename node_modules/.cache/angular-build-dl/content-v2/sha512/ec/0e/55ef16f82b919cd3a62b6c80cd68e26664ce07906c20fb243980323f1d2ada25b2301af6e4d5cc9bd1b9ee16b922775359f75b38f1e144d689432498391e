...
OfferComponent.ɵfac = function OfferComponent_Factory(t) { return new (t || OfferComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_0__["ModalController"])); };
OfferComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: OfferComponent, selectors: [["app-offer"]], decls: 25, vars: 0, consts: [[1, "ion-no-border"], ["slot", "end"], [3, "click"], ["name", "close"], ["size", "12"], ["hint", "decimal", "type", "number", "inputmode", "decimal", "value", "333", "clearOnEdit", "true"], ["detail", ""], ["size", "3"], ["src", "https://gravatar.com/avatar/dba6bae8c566f9d4041fb9cd9ada7741?d=identicon&f=y"], ["size", "9"], [1, "details-purchase-options-row"], ["color", "primary", "expand", "block", 3, "click"]], template: function OfferComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OfferComponent_Template_ion_button_click_5_listener() { return ctx.dismissModal(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OfferComponent_Template_ion_button_click_23_listener() { return ctx.makeOffer(); });
...
/* harmony import */ var _item_Item_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../item/Item-service */ "xkf5");
/* harmony import */ var _offer_offer_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../offer/offer.component */ "AxfY");
...
function ItemDetailPage_ion_slide_11_Template(rf, ctx) { if (rf & 1) {
...
function ItemDetailPage_ion_col_63_Template(rf, ctx) { if (rf & 1) {
...
function ItemDetailPage_ion_footer_64_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ItemDetailPage_ion_footer_64_Template_ion_button_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](); return ctx_r6.chat(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ItemDetailPage_ion_footer_64_Template_ion_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r7); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](); return ctx_r8.createModal(); });
...
const _c2 = function () { return ["/public-profile"]; };
class ItemDetailPage {
    constructor(itemService, modalController, router, routerOutlet, route) {
...
ItemDetailPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({ type: ItemDetailPage, selectors: [["app-item-detail"]], hostVars: 2, hostBindings: function ItemDetailPage_HostBindings(rf, ctx) { if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ItemDetailPage_Template_ion_button_click_2_listener() { return ctx.backClicked(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ionScroll", function ItemDetailPage_Template_ion_content_ionScroll_8_listener($event) { return ctx.onScroll($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ItemDetailPage_Template_ion_button_click_26_listener() { return ctx.chat(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ItemDetailPage_Template_ion_button_click_29_listener() { return ctx.createModal(); });
...
class ChatService {
    ...
    sendMsg(docId, txt, itemSaler, buyer, chatid) {
        ...
        msg.chatID = chatId;
        msg.item = docId.id;
        let createdDate = firebase_app__WEBPACK_IMPORTED_MODULE_4__["firestore"].FieldValue.serverTimestamp();
    ...
    getAllReceiveMsgs(user) {
        const received = this.afs
            .collection("chats", (ref) => ref.where("receiver.uid", "==", user).orderBy("created", "desc")).valueChanges();
        const sent = this.afs
            .collection("chats", (ref) => ref.where("sender.uid", "==", user).orderBy("created", "desc")).valueChanges();
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["combineLatest"])(received, sent).pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_5__["map"])((arr) => arr.reduce((acc, cur) => acc.concat(cur))));
    }
    getAllSentMsgs(user) {
        console.log("UUUUUUUUUSER" + user);
        return this.afs
            .collection("chats", (ref) => ref.where("sender.uid", "==", user).orderBy("created", "desc"))
            .valueChanges();
    }
    chatListGetMsgs(chat_Id) {
        console.log("MSGGGGGG DATA " + chat_Id);
        return this.afs
            .collection("chats", (ref) => ref.where("chatId", "==", chat_Id))
            .snapshotChanges()
            .pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_5__["map"])((actions) => {
            return actions.map((a) => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                console.log("########## Chat ############# =" + JSON.stringify(data));
                return this.afs
                    .collection("messages", (ref) => ref.where("chatID", "==", id).orderBy("created", "asc"))
                    .valueChanges()
                    .pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_5__["map"])((msgs) => {
                    console.log("+++++++++++++++++  message List +++++++++++++++ " +
                        JSON.stringify(Object.assign({ id, msgs: msgs }, data)));
                    return Object.assign(Object.assign({ id, msgs: msgs }, data));
                }));
            });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["flatMap"])((posts) => Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["combineLatest"])(posts)));
    }
    getMsgs(item, sender) {
        console.log("");
        ...
        return this.afs
            .collection("chats", (ref) => ref.where("chatId", "==", chatId))
            .snapshotChanges()
            .pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_5__["map"])((actions) => {
            return actions.map((a) => {
                const data = a.payload.doc.data();
    ...
    getAllReceiveMessages() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let sender = (yield this.afAuth.currentUser).uid;
    ...
    addNewMsg(item, imagesUrl) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            item.poster = (yield this.afAuth.currentUser).uid;
            item.images = [];
            item.likes = [];
            item.prices = [];
            item.offers = [];
...
ChatService.ɵfac = function ChatService_Factory(t) { return new (t || ChatService)(_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"])); };
ChatService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineInjectable"]({ token: ChatService, factory: ChatService.ɵfac });
...
/* harmony import */ var _item_detail_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./item-detail.page */ "BSaU");
...
class ItemDetailPageRoutingModule {
}
ItemDetailPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({ type: ItemDetailPageRoutingModule });
ItemDetailPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function ItemDetailPageRoutingModule_Factory(t) { return new (t || ItemDetailPageRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](ItemDetailPageRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] }); })();
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
/* harmony import */ var _item_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./item-detail-routing.module */ "gkt9");
/* harmony import */ var _item_detail_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./item-detail.page */ "BSaU");
...
/* harmony import */ var _offer_offer_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../offer/offer.component */ "AxfY");
/* harmony import */ var _item_Item_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../item/Item-service */ "xkf5");
/* harmony import */ var _chat_detail_chat_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../chat-detail/chat-service */ "LCrz");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
class ItemDetailPageModule {
}
ItemDetailPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineNgModule"]({ type: ItemDetailPageModule });
ItemDetailPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineInjector"]({ factory: function ItemDetailPageModule_Factory(t) { return new (t || ItemDetailPageModule)(); }, providers: [_Services_account_item_service__WEBPACK_IMPORTED_MODULE_6__["ItemService"], _item_Item_service__WEBPACK_IMPORTED_MODULE_8__["ItemFireStore"], _chat_detail_chat_service__WEBPACK_IMPORTED_MODULE_9__["ChatService"]], imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"],
            _item_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__["ItemDetailPageRoutingModule"],
            _components_components_module__WEBPACK_IMPORTED_MODULE_5__["ComponentsModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵsetNgModuleScope"](ItemDetailPageModule, { declarations: [_item_detail_page__WEBPACK_IMPORTED_MODULE_4__["ItemDetailPage"], _offer_offer_component__WEBPACK_IMPORTED_MODULE_7__["OfferComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"],
        _item_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__["ItemDetailPageRoutingModule"],
        _components_components_module__WEBPACK_IMPORTED_MODULE_5__["ComponentsModule"]], exports: [_offer_offer_component__WEBPACK_IMPORTED_MODULE_7__["OfferComponent"]] }); })();
