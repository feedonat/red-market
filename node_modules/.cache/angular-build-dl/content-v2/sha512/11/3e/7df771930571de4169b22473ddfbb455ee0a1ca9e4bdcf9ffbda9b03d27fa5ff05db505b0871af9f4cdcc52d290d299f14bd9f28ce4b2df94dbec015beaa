(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-profile-home-profile-home-module"], {
    ...
    /***/
    function DCv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProfileSettingComponent", function () {
      ...
      var _firebase_crud_user_firebase_user_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../../firebase/crud/user/firebase-user.model */
      "pXCI");
      /* harmony import */
      ...
      var ProfileSettingComponent = /*#__PURE__*/function () {
        function ProfileSettingComponent(modalController, alertController, router, ngZone) {
          _classCallCheck(this, ProfileSettingComponent);
        ...
        _createClass(ProfileSettingComponent, [{
          key: "ngOnInit",
      ...
      ProfileSettingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ProfileSettingComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileSettingComponent_Template_ion_button_click_4_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileSettingComponent_Template_ion_button_click_13_listener() {
    ...
    /***/
    function EMwN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _model_user_profile_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var UserService = /*#__PURE__*/function () {
        function UserService(platformId, transferStateHelper, http) {
        ...
        _createClass(UserService, [{
          ...
          value: function getProfileDataSource() {
            var rawDataSource = this.http.get('./assets/sample-data/user/user-profile.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
              // Note: HttpClient cannot know how to instantiate a class for the returned data
              // We need to properly cast types from json data
              var profile = new _model_user_profile_model__WEBPACK_IMPORTED_MODULE_4__["UserProfileModel"](); // The Object.assign() method copies all enumerable own properties from one or more source objects to a target object.
            ...
            var cachedDataSource = this.transferStateHelper.checkDataSourceState('profile-state', rawDataSource);
          ...
          value: function getProfileStore(dataSource) {
            ...
            if (!this.profileDataStore) {
              ...
              var shellModel = new _model_user_profile_model__WEBPACK_IMPORTED_MODULE_4__["UserProfileModel"]();
              this.profileDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_3__["DataStore"](shellModel); // If running in the server, then don't add shell to the Data Store
    ...
    /***/
    function EqPc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProfileHomePageRoutingModule", function () {
        return ProfileHomePageRoutingModule;
      });
      /* harmony import */
      ...
      var _profile_home_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./profile-home.page */
      "UvEM");
      /* harmony import */
      ...
      var ProfileHomePageRoutingModule = function ProfileHomePageRoutingModule() {
        _classCallCheck(this, ProfileHomePageRoutingModule);
      };

      ProfileHomePageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({
        type: ProfileHomePageRoutingModule
      });
      ProfileHomePageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
        factory: function ProfileHomePageRoutingModule_Factory(t) {
          return new (t || ProfileHomePageRoutingModule)();
        },
        imports: [[_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](ProfileHomePageRoutingModule, {
          imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]],
    ...
    /***/
    function NOm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function UvEM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProfileHomePage", function () {
      ...
      var _Services_theme_theme_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../Services/theme/theme.service */
      "N/Om");
      /* harmony import */


      var _firebase_auth_firebase_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../firebase/auth/firebase-auth.service */
      "T7tK");
      /* harmony import */


      var _Services_account_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../Services/account/user.service */
      "EMwN");
      /* harmony import */


      var _profile_setting_profile_setting_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./profile-setting/profile-setting.component */
      "1DCv");
      /* harmony import */
      ...
      var ProfileHomePage = /*#__PURE__*/function () {
        function ProfileHomePage(route, alertController, userService, authService, router, routerOutlet, modalController, themeSwitcher) {
          _classCallCheck(this, ProfileHomePage);
        ...
        _createClass(ProfileHomePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.subscriptions = this.userService.getProfileDataSource().subscribe(function (state) {
              _this2.profile = state;
            }, function (error) {
          ...
          value: function signOut() {
            ...
            this.authService.signOut().subscribe(function () {
              ...
              _this3.router.navigate(['redmarket/profile/auth/sign-in'], {
                replaceUrl: true
              });
            }, function (error) {
      ...
      ProfileHomePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
        ...
        template: function ProfileHomePage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function ProfileHomePage_Template_ion_item_click_42_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function ProfileHomePage_Template_ion_item_click_52_listener() {
              return ctx.ThemeSwitcher();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function ProfileHomePage_Template_ion_item_click_92_listener() {
              return ctx.signOut();
            });
    ...
    /***/
    function UzRt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProfileHomePageModule", function () {
        return ProfileHomePageModule;
      });
      /* harmony import */
      ...
      var _profile_home_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./profile-home-routing.module */
      "EqPc");
      /* harmony import */


      var _profile_home_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./profile-home.page */
      "UvEM");
      /* harmony import */
      ...
      var _Services_account_user_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../Services/account/user.service */
      "EMwN");
      /* harmony import */
      ...
      var _profile_setting_profile_setting_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./profile-setting/profile-setting.component */
      "1DCv");
      /* harmony import */
      ...
      var ProfileHomePageModule = function ProfileHomePageModule() {
        _classCallCheck(this, ProfileHomePageModule);
      };

      ProfileHomePageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineNgModule"]({
        type: ProfileHomePageModule
      });
      ProfileHomePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineInjector"]({
        factory: function ProfileHomePageModule_Factory(t) {
          return new (t || ProfileHomePageModule)();
        },
        providers: [_Services_account_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _firebase_auth_firebase_auth_service__WEBPACK_IMPORTED_MODULE_8__["FirebaseAuthService"]],
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _profile_home_routing_module__WEBPACK_IMPORTED_MODULE_3__["ProfileHomePageRoutingModule"], _shell_shell_module__WEBPACK_IMPORTED_MODULE_5__["ShellModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵsetNgModuleScope"](ProfileHomePageModule, {
          declarations: [_profile_home_page__WEBPACK_IMPORTED_MODULE_4__["ProfileHomePage"], _profile_setting_profile_setting_component__WEBPACK_IMPORTED_MODULE_9__["ProfileSettingComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _profile_home_routing_module__WEBPACK_IMPORTED_MODULE_3__["ProfileHomePageRoutingModule"], _shell_shell_module__WEBPACK_IMPORTED_MODULE_5__["ShellModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"]],
          exports: [_profile_setting_profile_setting_component__WEBPACK_IMPORTED_MODULE_9__["ProfileSettingComponent"]]
        });
      })();
      /***/
    ...
    function pXCI(module, __webpack_exports__, __webpack_require__) {
      ...
      var FirebaseSkillModel = /*#__PURE__*/function (_shell_data_store__WE) {
        _inherits(FirebaseSkillModel, _shell_data_store__WE);

        var _super = _createSuper(FirebaseSkillModel);
      ...
      var FirebaseUserModel = /*#__PURE__*/function (_shell_data_store__WE2) {
        _inherits(FirebaseUserModel, _shell_data_store__WE2);

        var _super2 = _createSuper(FirebaseUserModel);
      ...
      var FirebaseCombinedUserModel = /*#__PURE__*/function (_FirebaseUserModel) {
        ...
        var _super3 = _createSuper(FirebaseCombinedUserModel);
        ...
        function FirebaseCombinedUserModel() {
          ...
          _this5.skills = [new FirebaseSkillModel(), new FirebaseSkillModel(), new FirebaseSkillModel()];
          return _this5;
        }
    ...
    /***/
    function sKAJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var UserProfileModel = /*#__PURE__*/function (_shell_data_store__WE3) {
        _inherits(UserProfileModel, _shell_data_store__WE3);

        var _super4 = _createSuper(UserProfileModel);
...
//# sourceMappingURL=pages-profile-home-profile-home-module-es5.js.map