...
export declare class VgHlsDirective implements OnInit, OnChanges, OnDestroy {
    ...
    destroyPlayer(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<VgHlsDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<VgHlsDirective, "[vgHls]", ["vgHls"], { "vgHlsHeaders": "vgHlsHeaders"; "vgHls": "vgHls"; }, { "onGetBitrates": "onGetBitrates"; }, never>;
}
